...
export const AUTH_LOCAL_USERS_ENABLE = castBooleanEnv(
...
export const ANONYMOUS_USERS_ENABLE = castBooleanEnv(
  "ANONYMOUS_USERS_ENABLE",
  false
)
export const ALLOW_USER_SELF_DELETE = castBooleanEnv(
  "ALLOW_USER_SELF_DELETE",
  false
)
export const VERIFY_EMAILS = castBooleanEnv("VERIFY_EMAILS", false)
export const LOST_PASSWORD_ENABLE = castBooleanEnv(
